...
namespace Alkahest.Game
{
    ...
    public sealed class PrologoEscenografia : MonoBehaviour
    {
        ...
        // (R86, regla 15) Los marcadores depositoFinal/deposito2Final (las
        // bahías de la estantería R85) SE RETIRARON: Cesar vetó el apilado y
        // el renacer del REORDEN vuelve a los marcadores de arriba — mismos
        // sitios, ahora con tubo grueso y refill.
