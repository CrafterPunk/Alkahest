    ...
    public sealed class SimSync : NetworkBehaviour
    {
        ...
        public override void OnNetworkSpawn()
        {
            ...
            if (IsServer)
            {
                ...
                AlkahestGameBootstrap.ModoFundacion = false; AlkahestGameBootstrap.ModoGaleria = false; AlkahestGameBootstrap.ModoLaboratorio = false; // (R127) regla 59.
...
SolicitarSnapshotServerRpc(NetworkManager.LocalClientId);
        ...
        public override void OnNetworkDespawn()
        {
            ...
            AlkahestGameBootstrap.ModoFundacion = false; AlkahestGameBootstrap.ModoGaleria = false; AlkahestGameBootstrap.ModoLaboratorio = false; // (R127) regla 59. // (ronda 69g) la fuga gemela -- ver el bloque junto a CrearMundoEspejo.
